...
const DOKJIMS_DEFAULTS = {
  ...
  coaches: [
    { name: "관장님", role: "프로 선수 출신 · PT 경력 다수", quote: "운동은 즐거워야 오래갑니다. 처음 오시는 분들일수록 더 편하게 알려드리려고 해요. 부담 갖지 말고 편하게 놀러 오세요.", photo: "", photoPosition: "center" },
    { name: "트레이너쌤", role: "PT 경력 다수 · 재활 트레이닝 가능", quote: "통증 때문에 운동을 망설이셨다면 저부터 만나보세요. 몸 상태 먼저 확인하고, 무리 없는 선에서 시작하실 수 있게 도와드릴게요.", photo: "", photoPosition: "center" }
  ],
  offer: {
